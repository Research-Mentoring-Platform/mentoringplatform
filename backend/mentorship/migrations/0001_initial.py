    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('mentee', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='mentee_mentorships', to='mentee.mentee')),
                ('mentor', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='mentor_mentorships', to='mentor.mentor')),
            ],
        ),
        migrations.CreateModel(
            name='Research',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.IntegerField(choices=[(1, 'Ongoing'), (2, 'Finished'), (3, 'Terminated')], default=(1, 'Ongoing'))),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('meeting', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='summary', to='mentorship.meeting')),
            ],
        ),
        migrations.AddField(
            model_name='meeting',
            name='mentorship',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='meetings', to='mentorship.mentorship'),
        ),
        migrations.CreateModel(
            name='Education',
            fields=[
