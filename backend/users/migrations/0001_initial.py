...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('token', models.CharField(default=users.methods.generate_forgot_password_token, max_length=32)),
                ('valid_until',
                 models.DateTimeField(default=users.methods.generate_forgot_password_expiration_date_time)),
                ('user',
