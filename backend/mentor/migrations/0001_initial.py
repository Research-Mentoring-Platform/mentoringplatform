    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('department', models.ForeignKey(null=True, on_delete=django.db.models.deletion.RESTRICT, related_name='departments', to='mentor.mentordepartment')),
                ('designation', models.ForeignKey(null=True, on_delete=django.db.models.deletion.RESTRICT, related_name='designations', to='mentor.mentordesignation')),
                ('discipline', models.ForeignKey(null=True, on_delete=django.db.models.deletion.RESTRICT, related_name='disciplines', to='mentor.mentordiscipline')),
